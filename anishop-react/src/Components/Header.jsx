    ...
    <div className="w-screen">
      ...
      <header className="flex w-4/5 justify-between">
        ...
        <div className="search-bar relative w-4/5 mx-5">
          <input className="rounded-lg p-4 ps-10 block w-full text-gray-900 border focus:ring-1 border-gray-300 focus:border-key-secondary-color focus:ring-blue-300 outline-none" type="text" placeholder="Items, collection & seller" required/>
          <button className="absolute end-2.5 bottom-2.5 font-medium rounded-lg text-sm px-4 py-2 bg-blue-400 text-white focus:outline-none focus:ring-blue-300 focus:ring-1 hover:bg-blue-500" type="button" onClick={handleSearchClick}>
